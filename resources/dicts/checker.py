...
skill_list = ['teacher', 'hunter', 'fighter', 'runner', 'climber', 'swimmer', 'speaker', 'mediator', 'clever', 'insightful', 'sense', 'kit', 'story', 'lore', 'camp', 'medicine cat', 'star', 'omen', 'dream', 'clairvoyant', 'prophet', 'ghost',
